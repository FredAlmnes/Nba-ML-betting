...
| ODDS-01 | Phase 4 | In Progress (3/9 plans — persistence layer + offline timestamp/snapshot-parsing logic + HTTP client (live/historical-snapshot/historical-events fetch, retry/credit accounting), no backfill driver or live-bot rewire yet) |
